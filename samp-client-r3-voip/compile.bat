...
echo [//] 15%% Verificando arquivo samp-client-r3-voip.zip em archives...
if not exist "archives\samp-client-r3-voip.zip" (
    echo [Erro]: O arquivo samp-client-r3-voip.zip nao foi encontrado em archives!
    goto :error
)
timeout /t 2 /nobreak >nul
...
echo Iniciando compilacao do projeto (samp-client-r3-voip - SPC) em 5 segundos...
