...
class Samp_Client_R3_Voip:
    ...
    def Create_Initial_Interface(self):
        ...
        title = self.Create_Styled_Label(
            main_frame, 
            "Client R3 Voip Installer SA:MP", 
        ...
        subtitle = self.Create_Styled_Label(
            main_frame, 
            "Installer for SA:MP (San Andreas Multiplayer) mod, version 0.3.7 R3 Voip"
        )
    ...
    def Start_Client_Installation(self):
        ...
        def Client_Installation():
            ...
            zip_file = os.path.join(zip_path, "archives", "samp-client-r3-voip.zip")
