...
class Samp_Client_R3_Voip:
    ...
    def Skapa_Inledande_Granssnitt(self):
        ...
        titel = self.Skapa_Stiliserad_Etikett(
            huvud_ram, 
            "Installationsprogram Client R3 Voip SA:MP", 
        ...
        underrubrik = self.Skapa_Stiliserad_Etikett(
            huvud_ram, 
            "Installationsprogram for mod SA:MP (San Andreas Multiplayer), version 0.3.7 R3 Voip"
        )
    ...
    def Starta_Client_Installation(self):
        ...
        def Client_Installation():
            ...
            arkiv_zip = os.path.join(zip_stig, "archives", "samp-client-r3-voip.zip")
