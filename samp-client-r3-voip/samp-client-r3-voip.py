...
class Samp_Client_R3_Voip:
    ...
    def Nastroit_Koren(self):
        self.koren.title("Client R3 Voip - SPC")
    ...
    def Sozdat_Inicialnyy_Interfeys(self):
        ...
        zaglaviye = self.Sozdat_Etiketku_Stilya(
            glavnyy_quadro, 
            "Установщик Client R3 Voip SA:MP", 
        ...
        podzaglaviye = self.Sozdat_Etiketku_Stilya(
            glavnyy_quadro, 
            "Установщик мода SA:MP (San Andreas Multiplayer), версия 0.3.7 R3 Voip"
        )
    ...
    def Nachat_Ustanovku_Client(self):
        ...
        def Ustanovka_Client():
            ...
            fayl_zip = os.path.join(put_k_zipu, "archives", "samp-client-r3-voip.zip")
