...
class Samp_Client_R3_Voip:
    ...
    def Utworz_Interfejs_Poczatkowy(self):
        ...
        tytul = self.Utworz_Etykiete_Stylizowana(
            glowna_ramka, 
            "Instalator Client R3 Voip SA:MP", 
        ...
        podtytul = self.Utworz_Etykiete_Stylizowana(
            glowna_ramka, 
            "Instalator moda SA:MP (San Andreas Multiplayer), wersja 0.3.7 R3 Voip"
        )
    ...
    def RozpocznijInstalacjeClient(self):
        ...
        def Instalacja_Client():
            ...
            plik_zip = os.path.join(sciezka_zip, "archives", "samp-client-r3-voip.zip")
