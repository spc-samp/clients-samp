...
class Samp_Client_R3_Voip:
    ...
    def Koku_Yapilandirma(self):
        self.root.title("Client R3 Voip - SPC")
    ...
    def Baslangic_Arayuzu_Olustur(self):
        ...
        baslik = self.Etiket_Olustur(
            ana_cerceve, 
            "Client R3 Voip SA:MP Yukleyici", 
        ...
        alt_baslik = self.Etiket_Olustur(
            ana_cerceve, 
            "SA:MP (San Andreas Multiplayer) mod yukleyicisi, versiyon 0.3.7 R3 Voip"
        )
    ...
    def Client_Onay_Arayuzu(self):
        ...
        alt_baslik = self.Etiket_Olustur(
            ana_cerceve, 
            "Klasor basariyla dogrulandi. R3 Voip Client Sini yuklemek istiyor musunuz?"
        )
    ...
    def Client_Yuklemeye_Basla(self):
        ...
        def Client_Yukleme():
            ...
            zip_dosyasi = os.path.join(zip_yolu, "archives", "samp-client-r3-voip.zip")
