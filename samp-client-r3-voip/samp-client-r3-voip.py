...
class Samp_Client_R3_Voip:
    ...
    def Creer_Interface_Initiale(self):
        ...
        titre = self.Creer_Label_Stylise(
            cadre_principal, 
            "Installateur Client R3 Voip SA:MP", 
        ...
        sous_titre = self.Creer_Label_Stylise(
            cadre_principal, 
            "Installateur du mod SA:MP (San Andreas Multiplayer), version 0.3.7 R3 Voip"
        )
    ...
    def Commencer_Installation_Client(self):
        ...
        def Installation_Client():
            ...
            fichier_zip = os.path.join(chemin_zip, "archives", "samp-client-r3-voip.zip")
