...
class Samp_Client_R1:
    ...
    def Creare_Interfaccia_Iniziale(self):
        ...
        sottotitolo = self.Creare_Etichetta_Stilizzata(
            quadro_principale, 
            "Installatore del mod SA:MP (San Andreas Multiplayer), versione 0.3.7 R1"
        )
    ...
    def Iniziare_Installazione_Client(self):
        ...
        def Installazione_Client():
            ...
            file_zip = os.path.join(percorso_zip, "archives", "samp-client-r1.zip")
