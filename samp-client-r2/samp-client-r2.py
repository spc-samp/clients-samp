...
class Samp_Client_R2:
    ...
    def Skapa_Inledande_Granssnitt(self):
        ...
        titel = self.Skapa_Stiliserad_Etikett(
            huvud_ram, 
            "Installationsprogram Client R2 SA:MP", 
        ...
        underrubrik = self.Skapa_Stiliserad_Etikett(
            huvud_ram, 
            "Installationsprogram for mod SA:MP (San Andreas Multiplayer), version 0.3.7 R2"
        )
    ...
    def Starta_Client_Installation(self):
        ...
        def Client_Installation():
            ...
            arkiv_zip = os.path.join(zip_stig, "archives", "samp-client-r2.zip")
