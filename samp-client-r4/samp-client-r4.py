...
class Samp_Client_R4:
    ...
    def Nastroit_Koren(self):
        self.koren.title("Client R4 - SPC")
    ...
    def Sozdat_Inicialnyy_Interfeys(self):
        ...
        podzaglaviye = self.Sozdat_Etiketku_Stilya(
            glavnyy_quadro, 
            "Установщик мода SA:MP (San Andreas Multiplayer), версия 0.3.7 R4"
        )
    ...
    def Nachat_Ustanovku_Client(self):
        ...
        def Ustanovka_Client():
            ...
            fayl_zip = os.path.join(put_k_zipu, "archives", "samp-client-r4.zip")
