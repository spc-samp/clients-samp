...
class Samp_Client_R4:
    ...
    def Create_Initial_Interface(self):
        ...
        subtitle = self.Create_Styled_Label(
            main_frame, 
            "Installer for SA:MP (San Andreas Multiplayer) mod, version 0.3.7 R4"
        )
    ...
    def Start_Client_Installation(self):
        ...
        def Client_Installation():
            ...
            zip_file = os.path.join(zip_path, "archives", "samp-client-r4.zip")
