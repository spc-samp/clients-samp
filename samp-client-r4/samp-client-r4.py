...
class Samp_Client_R4:
    ...
    def Erstellen_Anfangsschnittstelle(self):
        ...
        titel = self.Erstellen_Beschriftung_Stilisiert(
            hauptrahmen, 
            "Installationsprogramm Client R4 SA:MP", 
        ...
        untertitel = self.Erstellen_Beschriftung_Stilisiert(
            hauptrahmen, 
            "Installationsprogramm für SA:MP Mod (San Andreas Multiplayer), Version 0.3.7 R4"
        )
    ...
    def Starten_ClientInstallation(self):
        ...
        def Installation_Client():
            ...
            zip_datei = os.path.join(zip_pfad, "archives", "samp-client-r4.zip")
