...
class Samp_Client_R5:
    ...
    def Baslangic_Arayuzu_Olustur(self):
        ...
        alt_baslik = self.Etiket_Olustur(
            ana_cerceve, 
            "SA:MP (San Andreas Multiplayer) mod yukleyicisi, versiyon 0.3.7 R5"
        )
    ...
    def Client_Onay_Arayuzu(self):
        ...
        alt_baslik = self.Etiket_Olustur(
            ana_cerceve, 
            "Klasor basariyla dogrulandi. R5 Client Sini yuklemek istiyor musunuz?"
        )
    ...
    def Client_Yuklemeye_Basla(self):
        ...
        def Client_Yukleme():
            ...
            zip_dosyasi = os.path.join(zip_yolu, "archives", "samp-client-r5.zip")
