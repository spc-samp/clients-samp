...
class Samp_Client_R5:
    ...
    def Creer_Interface_Initiale(self):
        ...
        sous_titre = self.Creer_Label_Stylise(
            cadre_principal, 
            "Installateur du mod SA:MP (San Andreas Multiplayer), version 0.3.7 R5"
        )
    ...
    def Commencer_Installation_Client(self):
        ...
        def Installation_Client():
            ...
            fichier_zip = os.path.join(chemin_zip, "archives", "samp-client-r5.zip")
