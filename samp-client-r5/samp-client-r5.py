...
class Samp_Client_R5:
    ...
    def Utworz_Interfejs_Poczatkowy(self):
        ...
        podtytul = self.Utworz_Etykiete_Stylizowana(
            glowna_ramka, 
            "Instalator moda SA:MP (San Andreas Multiplayer), wersja 0.3.7 R5"
        )
    ...
    def RozpocznijInstalacjeClient(self):
        ...
        def Instalacja_Client():
            ...
            plik_zip = os.path.join(sciezka_zip, "archives", "samp-client-r5.zip")
