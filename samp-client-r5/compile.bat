...
echo [//] 15%% Verificando arquivo samp-client-r5.zip em archives...
if not exist "archives\samp-client-r5.zip" (
    echo [Erro]: O arquivo samp-client-r5.zip nao foi encontrado em archives!
    goto :error
)
timeout /t 2 /nobreak >nul
...
echo Iniciando compilacao do projeto (samp-client-r5 - SPC) em 5 segundos...
