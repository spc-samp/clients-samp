...
class Samp_Client_R1_Voip:
    ...
    def Nastroit_Koren(self):
        self.koren.title("Client R1 Voip - SPC")
    ...
    def Sozdat_Inicialnyy_Interfeys(self):
        ...
        zaglaviye = self.Sozdat_Etiketku_Stilya(
            glavnyy_quadro, 
            "Установщик Client R1 Voip SA:MP", 
        ...
        podzaglaviye = self.Sozdat_Etiketku_Stilya(
            glavnyy_quadro, 
            "Установщик мода SA:MP (San Andreas Multiplayer), версия 0.3.7 R1 Voip"
        )
    ...
    def Nachat_Ustanovku_Client(self):
        ...
        def Ustanovka_Client():
            ...
            fayl_zip = os.path.join(put_k_zipu, "archives", "samp-client-r1-voip.zip")
