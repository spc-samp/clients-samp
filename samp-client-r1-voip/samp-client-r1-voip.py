...
class Samp_Client_R1_Voip:
    ...
    def Creare_Interfaccia_Iniziale(self):
        ...
        titolo = self.Creare_Etichetta_Stilizzata(
            quadro_principale, 
            "Installatore Client R1 Voip SA:MP", 
        ...
        sottotitolo = self.Creare_Etichetta_Stilizzata(
            quadro_principale, 
            "Installatore del mod SA:MP (San Andreas Multiplayer), versione 0.3.7 R1 Voip"
        )
    ...
    def Iniziare_Installazione_Client(self):
        ...
        def Installazione_Client():
            ...
            file_zip = os.path.join(percorso_zip, "archives", "samp-client-r1-voip.zip")
