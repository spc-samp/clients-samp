...
class Samp_Client_R1_Voip:
    ...
    def Utworz_Interfejs_Poczatkowy(self):
        ...
        tytul = self.Utworz_Etykiete_Stylizowana(
            glowna_ramka, 
            "Instalator Client R1 Voip SA:MP", 
        ...
        podtytul = self.Utworz_Etykiete_Stylizowana(
            glowna_ramka, 
            "Instalator moda SA:MP (San Andreas Multiplayer), wersja 0.3.7 R1 Voip"
        )
    ...
    def RozpocznijInstalacjeClient(self):
        ...
        def Instalacja_Client():
            ...
            plik_zip = os.path.join(sciezka_zip, "archives", "samp-client-r1-voip.zip")
