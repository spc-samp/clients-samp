...
class Samp_Client_R1_Voip:
    ...
    def Erstellen_Anfangsschnittstelle(self):
        ...
        titel = self.Erstellen_Beschriftung_Stilisiert(
            hauptrahmen, 
            "Installationsprogramm Client R1 Voip SA:MP", 
        ...
        untertitel = self.Erstellen_Beschriftung_Stilisiert(
            hauptrahmen, 
            "Installationsprogramm für SA:MP Mod (San Andreas Multiplayer), Version 0.3.7 R1 Voip"
        )
    ...
    def Starten_ClientInstallation(self):
        ...
        def Installation_Client():
            ...
            zip_datei = os.path.join(zip_pfad, "archives", "samp-client-r1-voip.zip")
