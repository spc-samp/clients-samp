...
class Samp_Client_R1_Voip:
    ...
    def Create_Initial_Interface(self):
        ...
        title = self.Create_Styled_Label(
            main_frame, 
            "Client R1 Voip Installer SA:MP", 
        ...
        subtitle = self.Create_Styled_Label(
            main_frame, 
            "Installer for SA:MP (San Andreas Multiplayer) mod, version 0.3.7 R1 Voip"
        )
    ...
    def Start_Client_Installation(self):
        ...
        def Client_Installation():
            ...
            zip_file = os.path.join(zip_path, "archives", "samp-client-r1-voip.zip")
