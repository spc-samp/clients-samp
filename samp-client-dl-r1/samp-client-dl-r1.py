...
class Samp_Client_DL_R1:
    ...
    def Creer_Interface_Initiale(self):
        ...
        titre = self.Creer_Label_Stylise(
            cadre_principal, 
            "Installateur Client DL R1 SA:MP", 
        ...
        sous_titre = self.Creer_Label_Stylise(
            cadre_principal, 
            "Installateur du mod SA:MP (San Andreas Multiplayer), version 0.3.7 DL R1"
        )
    ...
    def Commencer_Installation_Client(self):
        ...
        def Installation_Client():
            ...
            fichier_zip = os.path.join(chemin_zip, "archives", "samp-client-dl-r1.zip")
