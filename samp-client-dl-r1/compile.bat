...
echo [//] 15%% Verificando arquivo samp-client-dl-r1.zip em archives...
if not exist "archives\samp-client-dl-r1.zip" (
    echo [Erro]: O arquivo samp-client-dl-r1.zip nao foi encontrado em archives!
    goto :error
)
timeout /t 2 /nobreak >nul
...
echo Iniciando compilacao do projeto (samp-client-dl-r1 - SPC) em 5 segundos...
